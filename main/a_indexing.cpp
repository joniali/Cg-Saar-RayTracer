...
void a_indexing(){//SDL_Surface* screen) {
	...
	//loadOBJ(scene, "models/", "Android.obj");
	...
	//PerspectiveCamera cam1(Point(0, 0, 1000), Vector(0, 0, -1), Vector(0, 1, 0), pi / 8, pi / 6); //camera for android
	...
	//PerspectiveCamera cam2(Point(-1000, 0, 0), Vector(1, 0, 0), Vector(0, 1, 0), pi / 8, pi / 6); //camera for android
